...
return [
    ...
    "home" => [
        "hero_metrics" => [
            [
                "title" => "Boshlovchilar uchun tushunarli",
                "text" => "Nazariya, diagramma va amaliy misollar soddalashtirilgan ketma-ketlikda beriladi.",
            ],
            [
                "title" => "Modulma-modul o'rganish",
                "text" => "LAN, OSI, TCP/IP, IP manzillash va xavfsizlik mavzulari bosqichma-bosqich yoritiladi.",
            ],
        ],
        "benefits" => [
            [
            ...
            [
                "title" => "Amaliy terminlarni tez anglash",
                "text" => "Router, switch, subnetting, DNS va NAT kabi tushunchalar oddiy misollar bilan yodda qoladi.",
                "icon" => "🧩",
            ],
            [
                "title" => "Nazariyadan amaliyotga o'tish",
                "text" => "Har bir modul yakunida laboratoriya fikrlashi va keyingi amaliy qadamlar ko'rsatiladi.",
                "icon" => "🛠️",
            ],
        ],
        "reasons" => [
            [
                "title" => "Tushunchalarni vizual ko'rish",
                "text" => "Diagrammalar va qatlamli izohlar murakkab mavzuni yengil qabul qilishga yordam beradi.",
            ],
            [
                "title" => "O'z tezligingizda o'rganish",
                "text" => "Har bir modul alohida bo'lgani uchun o'zingizga qulay ketma-ketlikda qayta ko'rishingiz mumkin.",
            ],
            [
                "title" => "Tekshiruv uchun nazoratlar",
                "text" => "Qisqa savollar bilimdagi bo'shliqlarni darhol ko'rsatadi va mustahkamlashni osonlashtiradi.",
            ],
        ],
    ],
    "modules" => [
    ...
    "lesson" => [
        "module_label" => "03-modul",
        "module_title" => "OSI modeli",
        "progress" => 40,
        "current_lesson" => "3.2 - OSI qatlamlari vazifalari",
        "duration" => "12 daqiqa",
        "sidebar_lessons" => [
    ...
    "quiz" => [
        ...
        "questions" => [
            ...
            [
                "id" => "q2",
                "question" => "DNS xizmatining asosiy vazifasi nima?",
                "options" => ["IP manzil taqsimlash", "Domen nomini IP manzilga aylantirish", "Paketlarni shifrlash", "Tarmoq kabellarini tekshirish"],
                "answer" => 1,
            ],
            [
                "id" => "q3",
        ...
        "result" => [
            ...
            "highlights" => [
                ...
                "DNS xizmatining rolini to'g'ri tushundingiz",
                "Keyingi qadam sifatida amaliy misollarni ko'rish foydali bo'ladi",
            ],
        ],
    ],
    "dashboard" => [
        "overview" => [
            ["label" => "Umumiy o'zlashtirish", "value" => "31%", "icon" => "📈"],
            ["label" => "Tugallangan darslar", "value" => "18 ta", "icon" => "🎯"],
            ["label" => "O'rtacha nazorat natijasi", "value" => "84%", "icon" => "📝"],
            ["label" => "Haftalik faollik", "value" => "4 kun", "icon" => "🔥"],
        ],
        "continue" => [
            "module" => "OSI modeli",
        ...
        "completed_lessons" => [
            ["title" => "Tarmoq nima?", "module" => "01-modul", "time" => "Kecha"],
            ["title" => "LAN va WAN farqi", "module" => "02-modul", "time" => "2 kun oldin"],
            ["title" => "OSI modeliga kirish", "module" => "03-modul", "time" => "Bugun"],
        ],
        "scores" => [
            ["title" => "Kirish moduli testi", "score" => "90%", "status" => "A'lo"],
            ["title" => "LAN/MAN/WAN mini-nazorat", "score" => "82%", "status" => "Yaxshi"],
            ["title" => "OSI tezkor savollari", "score" => "78%", "status" => "Mustahkamlash kerak"],
        ],
        "module_progress" => [
            ["title" => "Kompyuter tarmoqlariga kirish", "progress" => 72],
            ["title" => "Tarmoq turlari: LAN, MAN, WAN", "progress" => 54],
            ["title" => "OSI modeli", "progress" => 40],
            ["title" => "TCP/IP modeli", "progress" => 28],
            ["title" => "IP manzillar va subnetting", "progress" => 16],
        ],
    ],
    "about" => [
        "purpose" => "Platforma kompyuter tarmoqlarini noldan o'rganishni soddalashtirish uchun ishlab chiqilmoqda. Maqsad - mavzuni haddan tashqari texnik ko'rsatmasdan, lekin professional yo'nalishga tayyorlaydigan asosiy bazani berish.",
        "methodology" => [
            "Qisqa nazariy bloklar va ko'zga tushunarli kartalar",
            "Har modul uchun ketma-ket dars tuzilmasi",
            "Diagramma, asosiy termin va mini-nazorat kombinatsiyasi",
            "Murakkab tushunchalarni oddiy real misollar bilan izohlash",
        ],
        "audiences" => [
        ...
        "outcomes" => [
            ...
            "IP manzil, subnet va marshrutlash mantig'ini tushunish",
            "Router, switch, DNS, DHCP va NAT xizmatlarining o'rnini bilish",
            "Oddiy tarmoq muammolarini qatlamlar bo'yicha tahlil qila olish",
        ],
        "steps" => [
            [
                "title" => "Boshlang'ich tushunchalarni mustahkamlash",
                "text" => "Avval tarmoq nima ekani va qurilmalar qanday bog'lanishini tushunasiz.",
            ],
            [
                "title" => "Model va protokollarni ko'rish",
                "text" => "Keyingi bosqichda OSI, TCP/IP va asosiy protokollar bilan tanishasiz.",
            ],
            [
                "title" => "Amaliy fikrlashga o'tish",
                "text" => "Yakunda qurilmalar, servislar va xavfsizlikni bitta umumiy kartinaga joylaysiz.",
            ],
        ],
    ],
];
